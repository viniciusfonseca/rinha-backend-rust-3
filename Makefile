...
build-image:
	docker build . -t distanteagle16/rinhabackend3-api:1.1.0 -f ./docker/Dockerfile.api.x86_64-unknown-linux-musl
	docker build . -t distanteagle16/rinhabackend3-worker:1.1.0 -f ./docker/Dockerfile.worker.x86_64-unknown-linux-musl

push-image:
	docker push distanteagle16/rinhabackend3-api:1.1.0
	docker push distanteagle16/rinhabackend3-worker:1.1.0